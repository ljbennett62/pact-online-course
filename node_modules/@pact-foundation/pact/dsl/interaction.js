...
var Interaction = /** @class */ (function () {
    ...
    Interaction.prototype.withRequest = function (requestOpts) {
        ...
        if (lodash_1.keys(request_1.HTTPMethod).indexOf(requestOpts.method.toString()) < 0) {
            throw new configurationError_1.default("You must provide a valid HTTP method: " + lodash_1.keys(request_1.HTTPMethod).join(", ") + ".");
        }
    ...
    Interaction.prototype.willRespondWith = function (responseOpts) {
        if (lodash_1.isNil(responseOpts.status) ||
     ...
     * @param query
     */
    Interaction.prototype.queryObjectIsValid = function (query) {
        Object.values(query).every(function (value) {
            if (matchers_1.isMatcher(value) ||
                Array.isArray(value) ||
                typeof value === "string") {
                return;
            }
